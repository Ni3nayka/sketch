...
void start() {
  ...
  c        = 3;  // счетчик для dor[][]
  dor[1][0] = 1; dor[1][1] = 2; dor[2][0] = 2; dor[2][1] = 1; 
  int a2   = 0;
  int myt  = 0;
  int newt = 0;
  x = 0; y = 0;
  ver[1][0] = 1; // обозначили стартовую локацию №1
  ver[2][0] = 2; ver[2][1] = 1; // обозначили вторую(переднюю локацию) 
  while (f == 0) {//---------------------------------------------
    ...
    if (A == 3.1) {
      if (napr == 1) { //dor[c][0] = i; dor[c][1] = j; c++; dor[c][0] = j; dor[c][1] = i; c++; 
