...
void process() {
  /*in1 = (map((analogRead(A1)), 296, 859, 2, 0));
  in2 = (map((analogRead(A2)), 534, 965, 1, 0));
  in3 = (map((analogRead(A3)), 664, 984, 1, 0));
  in4 = (map((analogRead(A4)), 324, 870, 1, 0));
  in0 = (map((analogRead(A0)), 455, 976, 1, 0));
  */
