...
void POD() {
  ...
  //while ((analogRead(A1) > 600) && (analogRead(A2) > 800) && (analogRead(A3) > 800) && (analogRead(A4) > 600)) {}
  linia();
  if (A == 6) {
    myt = 22; 
    L();
  ...
  if (A == 3.2) { R(); linia(); L(); linia(); out();  }
  if (A == 5.2) { R(); linia(); out();  }
  if (A == 5) { N(); linia(); R(); linia(); out(); }
  if (A == 5.1) {
    L();
    linia();
    if (A == 5.1) {
...
void scan() {
  ...
  while (f == 0) {//---------------------------------------------
    ...
    while (a > 0) {  //учитываем прямые участки пути
      ...
      dor[myt][myt] = 9; // отмечаем, что она прямая
      AV();
      a--;
    }
    if (napr == 1) { x++; }  // определяем координату
    ...
    if (f == 0) {
      ...
      flag = 0;
      while ((i < 34) && (flag == 0)) {
        if (((dor[myt][i] == 1) && (ver[i][1] == x + 1) && (ver[i][2] == y) && (ver[i][3] == 0)) || ((dor[myt][i] == 1) && (ver[i][1] == x - 1) && (ver[i][2] == y) && (ver[i][3] == 0)) || ((dor[myt][i] == 1) && (ver[i][1] == x) && (ver[i][2] == y + 1) && (ver[i][3] == 0)) || ((dor[myt][i] == 1) && (ver[i][1] == x) && (ver[i][2] == y - 1) && (ver[i][3] == 0))) {
          flag = 1;
        }
        i++;
      }
      ...
      if (flag == 1) {  // есть рядом неразведанные
        ...
        // вперед 
        while (!((ver[i][1] == x + 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 1) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 1)) { flag = 1; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y + 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 2) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 2)) { flag = 1; }; i = 1;
        while (!((ver[i][1] == x - 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 3) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 3)) { flag = 1; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y - 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 4) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 4)) { flag = 1; }; i = 1;
        // влево
        while (!((ver[i][1] == x + 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 2) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 2)) { flag = 2; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y + 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 3) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 3)) { flag = 2; }; i = 1;
        while (!((ver[i][1] == x - 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 4) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 4)) { flag = 2; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y - 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 1) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 1)) { flag = 2; }; i = 1;
        // вправо
        while (!((ver[i][1] == x + 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 4) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 4)) { flag = 3; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y + 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 1) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 1)) { flag = 3; }; i = 1;
        while (!((ver[i][1] == x - 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 2) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 2)) { flag = 3; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y - 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 3) && (i < 34)) { i++; } if ((dor[myt][i] == 1) && (i < 34) && (flag == 0) && (napr == 3)) { flag = 3; }; i = 1;
        Serial.println(flag);
        /*if (flag == 1) { V(); }
        if (flag == 2) { L(); }
        if (flag == 3) { R(); }*/
