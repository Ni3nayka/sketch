  ...
  while (f == 0) {//---------------------------------------------
    ...
    if (f == 0) {
      ...
      if (flag == 1) {  // есть рядом неразведанные
        ...
        // вперед 
        while (!((ver[i][1] == x + 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 1) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 1; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y + 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 2) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 1; }; i = 1;
        while (!((ver[i][1] == x - 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 3) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 1; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y - 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 4) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 1; }; i = 1;
        // влево
        while (!((ver[i][1] == x + 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 2) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 2; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y + 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 3) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 2; }; i = 1;
        while (!((ver[i][1] == x - 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 4) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 2; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y - 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 1) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 2; }; i = 1;
        // вправо
        while (!((ver[i][1] == x + 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 4) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 3; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y + 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 1) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 3; }; i = 1;
        while (!((ver[i][1] == x - 1) && (ver[i][2] == y) && (ver[i][3] == 0)) && (flag == 0) && (napr == 2) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 3; }; i = 1;
        while (!((ver[i][1] == x) && (ver[i][2] == y - 1) && (ver[i][3] == 0)) && (flag == 0) && (napr == 3) && (i < 34)) { i++; } if ((i < 34) && (flag == 0)) { flag = 3; }; i = 1;
        /*if (flag == 1) { V(); }
        if (flag == 2) { L(); }
        if (flag == 3) { R(); }*/
        if (flag == 2) { l(); }
