...
from arduino_trik import *

arduino_trik_version("1.2+") # test version

if (arduino_trik_version()!="1.2"):
    print("<arduino_trik> have more version!!!")
'''
