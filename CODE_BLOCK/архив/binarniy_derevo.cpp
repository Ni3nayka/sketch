/*
info:
https://purecodecpp.com/archives/2483
*/
...
void Add(char aData, Branch *&aBranch) { //Функция внесения данных
    ...
    if (!aBranch) { //создадим ее и зададим в нее данные
        ...
        if (aBranch->Data>aData) Add(aData, aBranch->LeftBranch);//Если оно меньше того, что в этой ветке - добавим влево
